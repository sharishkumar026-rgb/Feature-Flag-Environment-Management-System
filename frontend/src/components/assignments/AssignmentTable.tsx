...
export interface AssignmentTableProps {
  ...
  onDelete?: (assignment: Assignment) => void | Promise<void>;
  onCreate?: () => void;
}
...
const AssignmentTable: React.FC<AssignmentTableProps> = ({
  ...
  const filteredAssignments = useMemo(() => {
    ...
    return assignments.filter((assignment) => {
      ...
      return (
        ...
        featureName.toLowerCase().includes(searchValue) ||
        featureKey.toLowerCase().includes(searchValue) ||
        environmentName.toLowerCase().includes(searchValue) ||
        environmentKey.toLowerCase().includes(searchValue) ||
        userId.includes(searchValue) ||
        featureId.includes(searchValue) ||
        environmentId.includes(searchValue) ||
        assignmentId.includes(searchValue)
      );
    });
  }, [assignments, search]);
  ...
  const getStatus = (
    ...
    if (assignment.is_enabled === false) {
      return false;
    }
